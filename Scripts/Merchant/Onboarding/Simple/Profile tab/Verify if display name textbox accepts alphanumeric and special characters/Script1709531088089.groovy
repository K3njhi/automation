...
WebUI.scrollToElement(findTestObject('user settings/display_name_textlabel'), 0)

WebUI.setText(findTestObject('user settings/display_name_textbox'), 'qwertyuiopasdfghjklzrwrxcvtwetbnm1234567890-=!@#$%^&*()_+{}:"|>?<[];\'\\,./~`')
